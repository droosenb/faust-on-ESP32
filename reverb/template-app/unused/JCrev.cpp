...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("JCrev");
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = ((0.699999988f * fRec6[1]) + (0.0599999987f * float(input0[i])));
			fVec0[(IOTA & 511)] = fTemp0;
			fRec6[0] = fVec0[((IOTA - 346) & 511)];
			float fRec7 = (0.0f - (0.699999988f * fTemp0));
			float fTemp1 = (fRec6[1] + (fRec7 + (0.699999988f * fRec4[1])));
			fVec1[(IOTA & 127)] = fTemp1;
			fRec4[0] = fVec1[((IOTA - 112) & 127)];
			float fRec5 = (0.0f - (0.699999988f * fTemp1));
			float fTemp2 = (fRec4[1] + (fRec5 + (0.699999988f * fRec2[1])));
			fVec2[(IOTA & 63)] = fTemp2;
			fRec2[0] = fVec2[((IOTA - 36) & 63)];
			float fRec3 = (0.0f - (0.699999988f * fTemp2));
			float fTemp3 = (fRec3 + fRec2[1]);
			float fTemp4 = (fTemp3 + (0.773000002f * fRec0[1]));
			fVec3[(IOTA & 2047)] = fTemp4;
			fRec0[0] = fVec3[((IOTA - 1866) & 2047)];
			fRec1[0] = fTemp4;
			float fTemp5 = (fTemp3 + (0.73299998f * fRec8[1]));
			fVec4[(IOTA & 4095)] = fTemp5;
			fRec8[0] = fVec4[((IOTA - 2250) & 4095)];
			fRec9[0] = fTemp5;
			float fTemp6 = ((4.0f * fRec1[1]) + (4.0f * fRec9[1]));
...
JCrev::JCrev(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void JCrev::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float JCrev::getParamValue(const std::string& path)
{
