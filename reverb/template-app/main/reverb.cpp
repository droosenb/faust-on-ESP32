  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec21[0] = (iRec21[1] + 1);
			table[i] = std::sin((0.000191747604f * float((iRec21[0] + -1))));
			iRec21[1] = iRec21[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = (1.11764705f / fConst0);
		fConst3 = (0.714285731f / fConst0);
		fConst4 = (1.18181813f / fConst0);
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.87f);
		...
		fHslider5 = FAUSTFLOAT(0.87f);
		fHslider6 = FAUSTFLOAT(0.38f);
		fHslider7 = FAUSTFLOAT(0.75f);
		fHslider8 = FAUSTFLOAT(0.625f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("bandwidth", &fHslider1, 0.649999976f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("damping", &fHslider6, 0.379999995f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("decay", &fHslider5, 0.870000005f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("diff/decay1", &fHslider7, 0.75f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("diff/decay2", &fHslider8, 0.625f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("diff/in1", &fHslider3, 0.699999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("diff/in2", &fHslider4, 0.699999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("ingain", &fHslider2, 1.0f, 0.0f, 2.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("mix", &fHslider0, 0.870000005f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow9 = (fSlow2 * (1.0f - fSlow0));
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			fRec8[0] = (fSlow1 * (fRec8[1] + (fSlow2 * fTemp0)));
			float fTemp1 = (fRec8[0] - (fSlow3 * fRec6[1]));
			fVec0[(IOTA & 255)] = fTemp1;
			fRec6[0] = fVec0[((IOTA - 141) & 255)];
			float fRec7 = (fSlow3 * fTemp1);
			float fTemp2 = ((fRec7 + fRec6[1]) - (fSlow3 * fRec4[1]));
			fVec1[(IOTA & 127)] = fTemp2;
			fRec4[0] = fVec1[((IOTA - 106) & 127)];
			float fRec5 = (fSlow3 * fTemp2);
			float fTemp3 = ((fRec5 + fRec4[1]) - (fSlow4 * fRec2[1]));
			fVec2[(IOTA & 511)] = fTemp3;
			fRec2[0] = fVec2[((IOTA - 378) & 511)];
			float fRec3 = (fSlow4 * fTemp3);
			float fTemp4 = ((fRec3 + fRec2[1]) - (fSlow4 * fRec0[1]));
			fVec3[(IOTA & 511)] = fTemp4;
			fRec0[0] = fVec3[((IOTA - 276) & 511)];
			float fRec1 = (fSlow4 * fTemp4);
			float fTemp5 = (fRec0[1] + (fRec9[1] + (fRec1 + (fSlow7 * fRec19[1]))));
			fVec4[(IOTA & 1023)] = fTemp5;
			fRec22[0] = (fConst1 + (fRec22[1] - std::floor((fConst1 + fRec22[1]))));
			fRec19[0] = fVec4[((IOTA - int(std::min<float>(686.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec22[0]))]) + 671.0f))))) & 1023)];
			float fRec20 = (0.0f - (fSlow7 * fTemp5));
			fVec5[(IOTA & 8191)] = (fRec20 + fRec19[1]);
			fRec18[0] = (fSlow6 * (fRec18[1] + fVec5[((IOTA - 4453) & 8191)]));
			float fTemp6 = (fRec18[0] + (fSlow8 * fRec16[1]));
			fVec6[(IOTA & 2047)] = fTemp6;
			fRec23[0] = (fConst2 + (fRec23[1] - std::floor((fConst2 + fRec23[1]))));
			fRec16[0] = fVec6[((IOTA - int(std::min<float>(1816.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec23[0]))]) + 1799.0f))))) & 2047)];
			float fRec17 = (0.0f - (fSlow8 * fTemp6));
			fVec7[(IOTA & 4095)] = (fRec17 + fRec16[1]);
			float fTemp7 = (fSlow5 * fVec7[((IOTA - 3720) & 4095)]);
			float fTemp8 = (fTemp7 + (fRec0[1] + (fRec1 + (fSlow7 * fRec14[1]))));
			fVec8[(IOTA & 1023)] = fTemp8;
			fRec24[0] = (fConst3 + (fRec24[1] - std::floor((fConst3 + fRec24[1]))));
			fRec14[0] = fVec8[((IOTA - int(std::min<float>(686.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec24[0]))]) + 907.0f))))) & 1023)];
			float fRec15 = (0.0f - (fSlow7 * fTemp8));
			fVec9[(IOTA & 8191)] = (fRec15 + fRec14[1]);
			fRec13[0] = (fSlow6 * (fRec13[1] + fVec9[((IOTA - 4217) & 8191)]));
			float fTemp9 = (fRec13[0] + (fSlow8 * fRec11[1]));
			fVec10[(IOTA & 2047)] = fTemp9;
			fRec25[0] = (fConst4 + (fRec25[1] - std::floor((fConst4 + fRec25[1]))));
			fRec11[0] = fVec10[((IOTA - int(std::min<float>(1816.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec25[0]))]) + 2655.0f))))) & 2047)];
			float fRec12 = (0.0f - (fSlow8 * fTemp9));
			fVec11[(IOTA & 4095)] = (fRec12 + fRec11[1]);
			fRec9[0] = (fSlow5 * fVec11[((IOTA - 3162) & 4095)]);
			float fRec10 = fTemp7;
			float fTemp10 = ((fSlow0 * (fRec0[1] + (fRec9[1] + (fRec1 + fRec10)))) + (fSlow9 * fTemp0));
...
reverb::reverb(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void reverb::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float reverb::getParamValue(const std::string& path)
{
...
extern "C" void app_main()
{
    ...
    reverb* DSP = new reverb(48000, 32);
    DSP->start();
