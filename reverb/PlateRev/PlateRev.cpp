  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec23[0] = (iRec23[1] + 1);
			table[i] = std::sin((0.000191747604f * float((iRec23[0] + -1))));
			iRec23[1] = iRec23[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "PlateRev.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.3");
		m->declare("name", "PlateRev");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("PlateRev");
		ui_interface->addHorizontalSlider("Damping", &fHslider1, 0.379999995f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Decay", &fHslider0, 0.870000005f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Decay Diffusion 1", &fHslider5, 0.75f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Decay Diffusion 2", &fHslider6, 0.625f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Input Diffusion 1", &fHslider3, 0.699999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Input Diffusion 2", &fHslider4, 0.699999988f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("bandwidth", &fHslider2, 0.649999976f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec22[0] = (fSlow2 * (float(input0[i]) + fRec22[1]));
			float fTemp0 = (fRec22[0] - (fSlow3 * fRec20[1]));
			fVec0[(IOTA & 255)] = fTemp0;
			fRec20[0] = fVec0[((IOTA - 141) & 255)];
			float fRec21 = (fSlow3 * fTemp0);
			float fTemp1 = ((fRec21 + fRec20[1]) - (fSlow3 * fRec18[1]));
			fVec1[(IOTA & 127)] = fTemp1;
			fRec18[0] = fVec1[((IOTA - 106) & 127)];
			float fRec19 = (fSlow3 * fTemp1);
			float fTemp2 = ((fRec19 + fRec18[1]) - (fSlow4 * fRec16[1]));
			fVec2[(IOTA & 511)] = fTemp2;
			fRec16[0] = fVec2[((IOTA - 378) & 511)];
			float fRec17 = (fSlow4 * fTemp2);
			float fTemp3 = ((fRec17 + fRec16[1]) - (fSlow4 * fRec14[1]));
			fVec3[(IOTA & 511)] = fTemp3;
			fRec14[0] = fVec3[((IOTA - 276) & 511)];
			float fRec15 = (fSlow4 * fTemp3);
			float fTemp4 = (fRec14[1] + (fRec0[1] + (fRec15 + (fSlow5 * fRec12[1]))));
			fVec4[(IOTA & 1023)] = fTemp4;
			fRec24[0] = (fConst1 + (fRec24[1] - std::floor((fConst1 + fRec24[1]))));
			fRec12[0] = fVec4[((IOTA - int(std::min<float>(686.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec24[0]))]) + 671.0f))))) & 1023)];
			float fRec13 = (0.0f - (fSlow5 * fTemp4));
			fVec5[(IOTA & 8191)] = (fRec13 + fRec12[1]);
			fRec11[0] = (fSlow1 * (fRec11[1] + fVec5[((IOTA - 4453) & 8191)]));
			float fTemp5 = (fRec11[0] + (fSlow6 * fRec9[1]));
			fVec6[(IOTA & 2047)] = fTemp5;
			fRec25[0] = (fConst2 + (fRec25[1] - std::floor((fConst2 + fRec25[1]))));
			fRec9[0] = fVec6[((IOTA - int(std::min<float>(1816.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec25[0]))]) + 1799.0f))))) & 2047)];
			float fRec10 = (0.0f - (fSlow6 * fTemp5));
			fVec7[(IOTA & 4095)] = (fRec10 + fRec9[1]);
			float fTemp6 = (fSlow0 * fVec7[((IOTA - 3720) & 4095)]);
			float fTemp7 = (fTemp6 + (fRec14[1] + (fRec15 + (fSlow5 * fRec7[1]))));
			fVec8[(IOTA & 1023)] = fTemp7;
			fRec26[0] = (fConst3 + (fRec26[1] - std::floor((fConst3 + fRec26[1]))));
			fRec7[0] = fVec8[((IOTA - int(std::min<float>(686.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec26[0]))]) + 907.0f))))) & 1023)];
			float fRec8 = (0.0f - (fSlow5 * fTemp7));
			fVec9[(IOTA & 8191)] = (fRec8 + fRec7[1]);
			fRec6[0] = (fSlow1 * (fRec6[1] + fVec9[((IOTA - 4217) & 8191)]));
			float fTemp8 = (fRec6[0] + (fSlow6 * fRec4[1]));
			fVec10[(IOTA & 2047)] = fTemp8;
			fRec27[0] = (fConst4 + (fRec27[1] - std::floor((fConst4 + fRec27[1]))));
			fRec4[0] = fVec10[((IOTA - int(std::min<float>(1816.0f, std::max<float>(0.0f, ((16.0f * ftbl0mydspSIG0[int((32768.0f * fRec27[0]))]) + 2655.0f))))) & 2047)];
			float fRec5 = (0.0f - (fSlow6 * fTemp8));
			fVec11[(IOTA & 4095)] = (fRec5 + fRec4[1]);
			fRec0[0] = (fSlow0 * fVec11[((IOTA - 3162) & 4095)]);
			float fRec1 = (fRec14[1] + (fRec15 + fRec0[1]));
			float fRec2 = fTemp6;
			float fRec3 = ((fRec15 + fRec14[1]) + fTemp6);
			float fTemp9 = ((fRec0[0] + fRec1) - (fRec2 + fRec3));
...
PlateRev::PlateRev(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void PlateRev::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float PlateRev::getParamValue(const std::string& path)
{
...
extern "C" void app_main()
{
    ...
    PlateRev* DSP = new PlateRev(48000, 32);
    DSP->start();
