...
*/
#define EXAMPLE_WIFI_SSID "DirkESP"
#define EXAMPLE_WIFI_PASS "dirkpass"
...
static void udp_server_task(void *pvParameters)
{
    ...
    while (1) {
        ...
        Midpoint* mid = new Midpoint(48000, 32);
        mid->start();
        ...
        while (1) {
            ...
            // Data received
                ...
                while (pr.isOk() && (msg = pr.popMessage()) != 0) {
                    ...
                    ESP_LOGI(TAG, "message address: %s", address.c_str());
                    ESP_LOGI(TAG, "message from: %f", farg);
                    mid->setParamValue(address,farg);
