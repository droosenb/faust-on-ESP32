...
/* ------------------------------------------------------------
name: "Midpoint"
Code generated with Faust 2.22.4 (https://faust.grame.fr)
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "Midpoint.dsp");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider1 = FAUSTFLOAT(140.0f);
		fHslider2 = FAUSTFLOAT(2.7000000000000002f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Midpoint");
		ui_interface->addHorizontalSlider("beta", &fHslider2, 2.70000005f, 0.0f, 1000.0f, 0.100000001f);
		ui_interface->addHorizontalSlider("rho", &fHslider1, 140.0f, 0.0f, 10000.0f, 0.100000001f);
		ui_interface->addHorizontalSlider("sigma", &fHslider0, 10.0f, 0.0f, 1000.0f, 0.100000001f);
		ui_interface->addButton("start", &fButton0);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = ((fRec1[1] * (fSlow2 - fRec3[1])) - fRec2[1]);
			float fTemp1 = (fSlow0 + (fSlow1 * (fRec2[1] - fRec1[1])));
			fRec1[0] = (fRec1[1] + (fConst1 * (fSlow0 + (fSlow1 * ((fRec2[1] + (fConst2 * (fTemp0 - fTemp1))) - fRec1[1])))));
			float fTemp2 = (fRec1[1] + (fConst2 * fTemp1));
			float fTemp3 = (fRec3[1] + (fConst2 * ((fRec1[1] * fRec2[1]) - (fSlow3 * fRec3[1]))));
			float fTemp4 = (fRec2[1] + (fConst2 * fTemp0));
			fRec2[0] = (fRec2[1] + (fConst1 * ((fTemp2 * (fSlow2 - fTemp3)) - fTemp4)));
			fRec3[0] = (fRec3[1] + (fConst1 * ((fTemp4 * fTemp2) - (fSlow3 * fTemp3))));
			fRec0[0] = ((fRec1[0] + (0.995000005f * fRec0[1])) - fRec1[1]);
			fRec4[0] = ((fRec2[0] + (0.995000005f * fRec4[1])) - fRec2[1]);
			output0[i] = FAUSTFLOAT((0.000500000024f * (fRec0[0] + fRec4[0])));
			fRec5[0] = ((fRec3[0] + (0.995000005f * fRec5[1])) - fRec3[1]);
			output1[i] = FAUSTFLOAT((0.000500000024f * fRec5[0]));
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec0[1] = fRec0[0];
...
Midpoint::Midpoint(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void Midpoint::setParamValue(const std::string& path, float value)
{
